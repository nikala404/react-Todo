...
export default function ToDo({ name, date, markSvg, deleted, marked, id }) {
  return (
    <>
      <div className="parent_todo">
        ...
        <div className="mark_delete">
          <button className="mark" id={id} onClick={() => marked(id)}>
            {markSvg}
          </button>
          <button className="delete" onClick={() => deleted(id)}>
            <svg
